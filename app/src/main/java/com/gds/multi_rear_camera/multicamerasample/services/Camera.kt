package com.gds.multi_rear_camera.multicamerasample.services
...
import com.gds.multi_rear_camera.multicamerasample.extensions.getCaptureSize
import com.gds.multi_rear_camera.multicamerasample.extensions.getPreviewSize
import com.gds.multi_rear_camera.multicamerasample.extensions.isAutoExposureSupported
import com.gds.multi_rear_camera.multicamerasample.extensions.isContinuousAutoFocusSupported
...
class Camera constructor(private val cameraManager: CameraManager) {
    ...
    private val cameraStateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onError(_cameraDevice: CameraDevice, error: Int) {
            openLock.release()
            _cameraDevice.close()
            cameraDevice = null
            isClosed = true
    ...
    private fun setUpCameraId(manager: CameraManager): String {
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                Log.e("TN", "isLogicalCamera: ${isLogicalCamera}")
